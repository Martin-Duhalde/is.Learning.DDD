...
using CarRental.Infrastructure.Databases; /// CarRentalDbContext
...
public class RentalCancellFlowTests(CustomWebApplicationFactory<Program> factory) : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    public async Task should_register_and_cancel_rental()
    {
        ...
        // El endpoint devuelve GUID del rental creado
